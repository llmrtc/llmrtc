...
Environment variables:
  ...
  STREAMING_STT      Stream mic audio to STT live for interim transcripts
                     (default: false; needs a streaming STT provider, e.g.
...
const streamingSTT = process.env.STREAMING_STT === 'true';
