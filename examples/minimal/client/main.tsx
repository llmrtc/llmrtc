/**
 * Minimal LLMRTC Client Example
 *
 * This is the simplest possible frontend showing:
 * - Connection to LLMRTCServer
 * - Event handling for transcript, LLM, and TTS
